				...
				<div class="sidebar-wrapper active">
					<div class="sidebar-header position-relative">
						<div class="d-flex justify-content-between align-items-center">
							<div class="logo">
								<a href="index.html">
									<img src="/img/logo-horizontal.png" alt="Logo" srcset="" style="height: 38px;"/>
								</a>
							</div>
					...
					<div class="sidebar-menu">
						<ul class="menu">
                            ...
                            <li class="sidebar-item {{ Route::current()->getName() == 'trash.transaction' ? 'active' : '' }}">
								<a href="/cms/trash/transaction" class="sidebar-link">
